...
public class RestController {
	...
	@GetMapping("/api/saveAll")
	public boolean saveAll() {
		return drinkService.addAll();
	}
	
	@GetMapping("/api/getByLetter")
	public List<Drink> getByLetter(@RequestParam  char let) {
		return drinkService.getListByLetter(let);
		
	}
	
	@GetMapping("/api/destroyAll")
	public boolean deleteAll() {
		return drinkService.deleteAll();	
	}
